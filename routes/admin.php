...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function() {
        ...
        Route::post('/stores/bulk/transaction/save', [StoreController::class, 'bulktransactionUpload'])->name('transaction.save');
        //states
	...
	Route::prefix('reward')->name('reward.')->group(function () {
        ...
        Route::prefix('/qrcode')->name('retailer.barcode.')->group(function () {
          ...
          Route::prefix('/qrcode/redeem')->name('qrcode.redeem.')->group(function () {
            ...
            Route::post('/edit/{id}', [BarcodeController::class, 'qrRedeemEdit'])->name('edit');
            Route::post('/update/{id}', [BarcodeController::class, 'qrRedeemUpdate'])->name('update');
            Route::delete('/delete/{id}', [BarcodeController::class, 'qrRedeemDelete'])->name('delete');
