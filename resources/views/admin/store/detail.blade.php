                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="{{ route('admin.stores.index') }}" class="btn btn-danger">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"></polyline></svg>
                               Return to store list
                            </a>
							 
							
							@if(!empty($data->stores->id))
                            <a href="{{ route('admin.stores.edit', $data->stores->id) }}" class="btn btn-success">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-3">
                            <div class="form-group">
                                ...
                                <h5> {{ $data->stores->district ? $data->stores->district : 'NA' }}</h5>
                            </div>
                        </div>
                    </div>
