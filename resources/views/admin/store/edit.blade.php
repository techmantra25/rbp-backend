...
<section class="inner-sec1">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.stores.update', $data->stores->id) }}" enctype="multipart/form-data">@csrf @method('PUT')
                        <div class="row mb-2">
                            <div class="col-12">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <select class="form-select select2" id="ase" name="ase_id"  aria-label="Floating label select example">
                                            ...
                                            @foreach ($data->users as $item)
                                                ...
                                                <option value="{{$item->id}}" {{($item->id==$data->stores->users->id) ? 'selected' : '' }}>{{$item->name}}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="gst_no" name="gst_no" placeholder="GST number" value="{{ old('gst_no') ? old('gst_no') : $data->stores->gst_no }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="pan_no" name="pan_no" placeholder="Pan number" value="{{ old('pan_no') ? old('pan_no') : $data->stores->pan_no }}">
                        ...
                        <div class="row mb-2">
							...
							<div class="col-md-4">
                                <div class="form-group">
									<label for="area">City <span class="text-danger">*</span></label>
                                    <div class="form-floating mb-3">
                                ...
                                <div class="form-group">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="district" name="district" placeholder="" value="{{ old('district') ? old('district') : $data->stores->district }}">
                                        <label for="pin">District Name  <span class="text-danger">*</span></label>
                                    </div>
                                    @error('district') <p class="small text-danger">{{$message}}</p> @enderror
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="pin" name="pin" placeholder="name@example.com" value="{{ old('pin') ? old('pin') : $data->stores->pin }}" readonly>
