        ...
        <div class="search__filter mb-0">
            ...
            <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <a href="{{ url()->current() }}" class="btn btn-sm btn-light clear-filter" data-bs-toggle="tooltip" title="Clear Filter"><iconify-icon icon="basil:cross-outline"></iconify-icon></a>
                                        </div>
                                        <div class="search-filter-right-el">
                                            <a href="{{ route('admin.sizes.create') }}" class="btn btn-danger btn-sm">
                                                    <iconify-icon icon="prime:plus-circle"></iconify-icon> Create New Size
                                                </a>
                                        </div>
                                    </div>
                                </form>
            ...
            <!--        <form class="row align-items-end justify-content-end" action="{{ route('admin.sizes.index')}}" method="GET">-->
            <!--            <div class="col-auto">-->
            <!--                <input type="search" name="term" id="term" class="form-control" placeholder="Search here.." value="{{app('request')->input('term')}}" autocomplete="off">-->
            <!--            </div>-->
            <!--            <div class="col-auto">-->
                        ...
                        <td>
                            ...
                            <div class="row__action">
                                <form action="{{ route('admin.sizes.destroy',$item->id) }}" method="POST">
                                    ...
                                    <a href="{{ route('admin.sizes.show', $item->id) }}">View</a>
                                    <a href="{{ route('admin.sizes.status', $item->id) }}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</a>
                                    @csrf
                                    @method('DELETE')
