...
@section('page', 'PRODUCTIVITY REPORT')
...
<section>
    <div class="card card-body">
        <div class="search__filter mb-0">
            <div class="row">
                <div class="col-md-3">
                    <h5>Export Productivity Report</h5>
                </div>
                <div class="col-md-9 text-end">
                    <form action="{{ route('admin.man.wise.productivity.report.csv.export') }}" method="GET">
                        ...
                        {{-- State Dropdown --}}
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control form-control-sm select2" name="user">
                                    ...
                                    @foreach ($aseDetails as $index => $item)
                                    <option value="{{ $item->id }}" {{ ($request->user == $item->id) ? 'selected' : '' }}>
