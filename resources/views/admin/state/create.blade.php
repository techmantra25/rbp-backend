...
<section class="inner-sec1">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.states.store') }}" enctype="multipart/form-data">@csrf
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="title" name="code" placeholder="name@example.com" value="{{ old('code') }}">
