...
<section class="pro-sec">
    <div class="card card-body">
        <div class="search__filter mb-0">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <a href="{{ url()->current() }}" class="btn btn-sm btn-light clear-filter" data-bs-toggle="tooltip" title="Clear Filter">
                                    <iconify-icon icon="basil:cross-outline"></iconify-icon>
                                        ...
                                        <div class="search-filter-right-el">
                                            <a href="{{ route('admin.states.create') }}" class="btn btn-danger btn-sm">
                        <iconify-icon icon="prime:plus-circle"></iconify-icon> Create New State
                    </a>
                                        </div>
                                    </div>
                                </form>
            ...
            <!--        <form class="row align-items-end justify-content-end" action="{{ route('admin.states.index')}}" method="GET">-->
            <!--            <div class="col-auto">-->
            <!--                <input type="search" name="term" id="term" class="form-control" placeholder="Search here.." value="{{app('request')->input('term')}}" autocomplete="off">-->
            <!--            </div>-->
            <!--            <div class="col-auto">-->
    			 ...
    			 @php
                   ...
                   @endphp
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="row__action">
                                <form action="{{ route('admin.states.destroy',$item->id) }}" method="POST">
                                    ...
                                    <a href="{{ route('admin.states.show', $item->id) }}">View</a>
                                    <a href="{{ route('admin.states.status', $item->id) }}">{{($item->status == 1) ? 'Active' : 'Inactive'}}</a>
                                    @csrf
                                    @method('DELETE')
                        ...
                        <td>
                            <p class="text-dark mb-0">{{$item->code}}</p>
                        </td>
                        <td>
