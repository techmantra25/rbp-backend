                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            <a href="{{ route('admin.users.collection', $data->user->id) }}" class="btn btn-primary">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="text-dark">Manager information</p>
                        </div>
                        <div class="col-md-4 mb-3">
					...
					@if(count($data->storeList)>0)
					 <div class="row">
                        ...
                        @forelse ($data->storeList as $item)
                            ...
                            <div class="col-md-4 mb-3">
                                <a href="{{ route('admin.stores.show', $item->store_id) }}"><h5>{{$item->store->name ?? ''}}</h5></a>
                            </div>
                        @empty
                            <div class="col-md-4 mb-3">
