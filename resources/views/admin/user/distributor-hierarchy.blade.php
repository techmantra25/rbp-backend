                                            ...
                                            <div class="search-filter-right search-filter-right-store mt-4">
                                              ...
                                              <div class="search-filter-right-el">
                                                ...
                                                <div class="search-filter-right-el align-self-end">
                                                  <a href="{{ route('admin.distributors.hiererchy.export', ['term'=>$request->term]) }}" class="btn btn-outline-danger btn-sm" data-bs-toggle="tooltip" title="Export data in CSV">
