...
@section('page', 'Store Engagement Activity Form')
@section('content')
                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Retailer Contact Person1 Name</th>
                                <th>Retailer Contact Person1 Mobile</th>
                                 <th>Retailer Contact Person2 Name</th>
                                 <th>Retailer Contact Person2 Mobile</th>
                                 <th>Email</th>
                                 <th>Dob</th>
                                  <th>GST</th>
                                <th>Distributor 1</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center column-thumb">
                                   @if(!empty($item->users->image))
                                    <img src="{{ asset($item->users->image) }}" style="max-width: 80px;max-height: 80px;">
                                    
                                   @endif
                                </td>
                                <td>{{ $item->users->unique_code??'' }}</td>
                                <td>
                                    {{ ucwords($item->users->name)}}
                                    
                                </td>
                                <td>
                                    {{ ucwords($item->users->address) }}<br>{{ $item->users->areas->name ??'' }}<br>{{ $item->users->areas->name ??''}}<br>{{ $item->users->states->name ??''}}
                                    
                                </td>
                                <td>{{ $item->users->pin }}</td>
                                <td>
                                    {{  $item->users->contact_person_fname.' '.$item->users->contact_person_lname  }}
                                </td> 
                                <td>{{ $item->users->contact_person_phone }}</td>
                                <td>{{ $item->retailer_contact_person2_name ?? '' }}</td>
                                <td>{{ $item->retailer_contact_person2_mobile ?? ''}}</td>
                                 <td>{{ $item->users->email }}</td>
                                <td>{{ $item->users->dob }}</td>
                                <td>{{ $item->users->gst }}</td>
                                <td>{{ $storename->distributors->name??'' }}</td>
                                <td>{{ $item->distributor2 ?? ''}}</td>
                                 <td>{{ $item->target }}</td>
