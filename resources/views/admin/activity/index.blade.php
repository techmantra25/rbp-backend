                                  ...
                                  <div class="search-filter-right-el">
                                      <form class="row align-items-end justify-content-end" action="" method="GET">
                                          ...
                                          <div class="search-filter-right search-filter-right-store mt-2">
                                              ...
                                              <div class="search-filter-right-el">
                                      <a href="{{ route('admin.users.activity.csv.export',['date_from'=>$request->date_from,'date_to'=>$request->date_to,'zsm'=>$request->zsm,'state' => $request->state,'rsm'=>$request->rsm,'sm'=>$request->sm,'asm'=>$request->asm,'ase'=>$request->ase]) }}" class="btn btn-outline-danger btn-sm" data-bs-toggle="tooltip" title="Export data in CSV">
                        ...
                        <tbody>
                            ...
                            @endphp
                                <tr>
                                    ...
                                    <td> <span class="badge bg-{{($item->users->status == 1) ? 'success' : 'danger'}}">{{($item->users->status == 1) ? 'Active' : 'Inactive'}}</span> </td>
                                    <td> {{ $item->users->designation ? $item->users->designation : userTypeName($item->users->type) }} </td>
                                    ...
                                    <td> {{ $item->location }} </td>
                                    @if($item->type=='leave')
                                    <td><a href="{{route('admin.users.activity.remove',$item->id)}}" type="button" class="btn btn-danger">Remove leave</a></td>
                                    @endif
                                </tr>
                            @empty
